...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/BarnumSN_HighPriority.htm"));
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                            <td valign="top"><br>
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image1" Visible="false" runat="server" />
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image2" Visible="false" runat="server" />
                                <asp:Label ID="lblImage2Info" runat="server" /><br>
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image3" Visible="false" runat="server" />
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image4" Visible="false" runat="server" />
                                <asp:Label ID="lblImage4Info" runat="server" /><br>    
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image5" Visible="false" runat="server" />
                                <asp:Label ID="lblImage5Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image6" Visible="false" runat="server" />
                                <asp:Label ID="lblImage6Info" runat="server" /><br>       
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image7" Visible="false" runat="server" />
                                <asp:Label ID="lblImage7Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNHighPrioAll"><asp:Image ID="Image8" Visible="false" runat="server" />
                                <asp:Label ID="lblImage8Info" runat="server" /><br>                               
                            </td>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
