                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <a href="GridOnly_Dashboard.aspx?Page=Framework_Active"><asp:Image ID="Image1" Visible="false" runat="server" /><br>
                                ...
                                <a href="GridOnly_Dashboard.aspx?Page=Framework_Pending"><asp:Image ID="Image3" Visible="false" runat="server" /><br>
                                ...
                                <a href="GridOnly_Dashboard.aspx?Page=Framework_OTEK"><asp:Image ID="Image6" Visible="false" runat="server" /><br>
