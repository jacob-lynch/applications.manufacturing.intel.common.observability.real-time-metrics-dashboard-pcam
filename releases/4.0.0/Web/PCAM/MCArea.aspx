                    ...
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView2" CssClass="GridView" runat="server" Width="75%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
                                ...
                                <asp:GridView ID="GridView3" CssClass="GridView" runat="server" Width="75%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
