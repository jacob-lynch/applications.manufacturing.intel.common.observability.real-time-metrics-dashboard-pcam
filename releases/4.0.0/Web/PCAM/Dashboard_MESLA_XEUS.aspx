...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/MES Lot Attributes_XEUS.htm"));
                  ...
                  <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView1" CssClass="GridView" runat="server" Width="20%" GridLines="Vertical"
