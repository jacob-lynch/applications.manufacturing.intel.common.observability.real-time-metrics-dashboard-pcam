...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/Purge_CRM_Configuration.htm"));
         Response.Write("<font face=Tahoma size=4>Updated: " + f1.LastWriteTime.ToString() + "</font>");
        %>
	<%Response.Write("</td></tr></table>");%>
</font>
        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" />
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="Output/Purge_CRM_Configuration.xlsx">Purge Configuration Summary - Excel</asp:Hyperlink>
