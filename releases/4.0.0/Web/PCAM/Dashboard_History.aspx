...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/NTSC CC History Merged.htm"));
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <a href="GridOnly_Dashboard_NTSC.aspx?Page=NTSCHistoryTT"><asp:Image ID="Image1" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage1Info" CssClass="LabelInfo" runat="server" /><br>
                                <a href="GridOnly_Dashboard_NTSC.aspx?Page=NTSCHistoryTT"><asp:Image ID="Image2" Visible="false" runat="server" /><br>
