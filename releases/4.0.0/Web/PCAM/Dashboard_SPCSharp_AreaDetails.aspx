                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                            <td valign="top"><br>
                                <asp:Image ID="Image1" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <asp:Image ID="Image3" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <asp:Image ID="Image5" Visible="false" runat="server" /><br>
                                ...
                                <asp:Image ID="Image9" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage9Info" runat="server" />
                                <asp:Image ID="Image11" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage11Info" runat="server" />
                                <asp:Image ID="Image13" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage13Info" runat="server" />
                                <asp:Image ID="Image15" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage15Info" runat="server" />
                            </td>
                            <td valign="top"><br>
                                <asp:Image ID="Image2" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <asp:Image ID="Image4" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage4Info" runat="server" />        
                                <asp:Image ID="Image6" Visible="false" runat="server" /><br>
                                ...
                                <asp:Image ID="Image10" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage10Info" runat="server" />
                                <asp:Image ID="Image12" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage12Info" runat="server" />
                                <asp:Image ID="Image14" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage14Info" runat="server" />
                                <asp:Image ID="Image16" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage16Info" runat="server" />                                                    
                            </td>
                            </tr>
                            <tr>
                            </ContentTemplate>
