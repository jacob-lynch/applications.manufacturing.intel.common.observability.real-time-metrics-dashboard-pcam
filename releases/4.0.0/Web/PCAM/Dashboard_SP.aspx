...
<table border="0" cellpadding="0" cellspacing="0">
 <tr>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        ...
                        <ContentTemplate>
                            <td valign="top"><br>
                                <a href="GridOnly_Dashboard.aspx?Page=SP_Details_Enable"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=SP_Details_IUF"><asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=SP_Details_WVE"><asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage5Info" runat="server" />
                            </td>
                            <td valign="top"><br>
                                <a href="GridOnly_Dashboard.aspx?Page=SP_Details_Enable"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=SP_Details_IUF"><asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" />     
                               <a href="GridOnly_Dashboard.aspx?Page=SP_Details_WVE"><asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
