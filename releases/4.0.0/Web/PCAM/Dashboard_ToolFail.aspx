...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/ToolFail_Metrics.htm"));
...
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                ...
                <tr>
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                            <td colspan=2">
                                <a href="GridOnly_Dashboard.aspx?Page=ToolFailEscalationThisWeek"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                            </td>
                            </tr>
                            <tr>
                            <td valign="top">
                                <a href="GridOnly_Dashboard.aspx?Page=ToolFailEscalationLastWeek"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" />
                                <asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage6Info" runat="server" />
                                <a href="Dashboard_Misconfigs.aspx?Page=ToolFailMisconfigs"><asp:Image ID="Image8" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage8Info" runat="server" />                              
                            </td>
                            <td valign="top">
                                <asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
