...
<link href="../PCAM/PCAMStyleSheet.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(function () {
            $('input#GridView3_search').quicksearch('table#GridView3 tbody tr');
        })
    </script>
...
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                    ...
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView2" CssClass="GridView" runat="server" Width="70%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
     ...
     <table border=0 width=100% cellpadding=0 cellspacing=0>
		    <td>
                	<span id="lblGridView3Header" class="GridHeader"><b></b></span>
			<a id="HyperLinkGridView3Export"></a>&nbsp;
			<input id="GridView3_search" type="text" placeholder="Search" STYLE="font-size: 10px;" maxlength=50>
		    </td>
		</table>                         
                    ...
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNResolvedDetails"><asp:Image ID="Image2" Visible="false" runat="server" /><br>
