...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/Purge_CRM_Configuration_XEUS.htm"));
         Response.Write("<font face=Tahoma size=4>Updated: " + f1.LastWriteTime.ToString() + "</font>");
        %>
	<%Response.Write("</td></tr></table>");%>
</font>
        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" />
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="Output/Purge_CRM_Configuration_XEUS.xlsx">Purge Configuration Summary - Excel</asp:Hyperlink>
    <p>
                                 </p>
 <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="Output/PurgeConfigOverride_CRM_TW.xlsx">TW in PurgeOperationConfigEx - Excel</asp:Hyperlink>
    <p>
                                 </p>
 <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="Output/LotPurgeOverrideConfig_CRM_TW.xlsx">LotPurgeOverrideConfig - Excel</asp:Hyperlink>
                    ...
                    <td valign="top">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView1" CssClass="GridView" runat="server" Width="55%" GridLines="Vertical"
                                ...
                                <asp:GridView ID="GridView2" CssClass="GridView" runat="server" Width="55%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
