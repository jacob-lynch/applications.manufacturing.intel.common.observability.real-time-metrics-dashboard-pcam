                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                            <td valign="top"><br>
                                <a href="barnumDashboardGridOnBottom.aspx?Page=BarnumMetricsThisWeek"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="barnumDashboardGridOnBottom.aspx?Page=BarnumMetricsThisYear"><asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="barnumDashboardGridOnBottom.aspx?Page=BarnumMetricsThisYear"><asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage5Info" runat="server" />
                                <a href="BarnumDashboardGridOnBottom.aspx?Page=BarnumMetricsAllTime"><asp:Image ID="Image7" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage7Info" runat="server" />
                            </td>
                            <td valign="top"><br>
                                <a href="BarnumDashboardGridOnBottom.aspx?Page=BarnumMetricsLastWeek"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <a href="barnumDashboardGridOnBottom.aspx?Page=BarnumMetricsLastYear"><asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" />        
                                <a href="barnumDashboardGridOnBottom.aspx?Page=BarnumMetricsLastYear"><asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage6Info" runat="server" />  
                                <a href="BarnumDashboardGridOnBottom.aspx?Page=BarnumMetricsAllTime"><asp:Image ID="Image8" Visible="false" runat="server" /></a><br>
