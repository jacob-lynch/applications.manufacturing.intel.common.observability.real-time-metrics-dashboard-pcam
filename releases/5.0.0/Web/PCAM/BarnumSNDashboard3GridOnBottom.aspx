...
<body topmargin="5" runat="server" id="Body1">
    ...
    <font style="font-size: 20">
        <asp:Label ID="lblTitle" runat="server" Visible="true" CssClass="Header1" /></font>
                    ...
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <td valign="top"><br>
                                ...
                                <asp:Image ID="Image6" Visible="false" runat="server" />
                                <asp:Label ID="lblImage6Info" runat="server" /><br>                                      
                                <asp:Image ID="Image7" Visible="false" runat="server" />
                                <asp:Label ID="lblImage7Info" runat="server" /> 
                                <asp:Image ID="Image8" Visible="false" runat="server" />
