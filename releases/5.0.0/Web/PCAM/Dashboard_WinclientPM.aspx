...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/Winclient Reboots.htm"));
...
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                    ...
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <a href="GridOnly_Dashboard.aspx?Page=WCPMDetails"><asp:Image ID="Image1" Visible="false" runat="server" /><br>
                  ...
                  <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView1" CssClass="GridView" runat="server" Width="75%" GridLines="Vertical"
