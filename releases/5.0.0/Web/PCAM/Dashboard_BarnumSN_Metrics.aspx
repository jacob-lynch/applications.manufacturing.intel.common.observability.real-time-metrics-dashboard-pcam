...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/BarnumSN_Metrics.htm"));
...
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                &nbsp;
                                <asp:Label ID="Text7" CssClass="LabelValue" runat="server" Visible="false" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                    </td>
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                            <td valign="top"><br>
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsThisWeek"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNBARTThisYear"><asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsThisYear"><asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage5Info" runat="server" />
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsThisYear"><asp:Image ID="Image7" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage7Info" runat="server" />
                                <a href="BarnumSNDashboard3GridOnBottom.aspx?Page=BarnumSNMetricsAllTime"><asp:Image ID="Image9" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage9Info" runat="server" />
                            </td>
                            <td valign="top"><br>
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsLastWeek"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=BarnumSNBARTLastYear"><asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" /> 
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsLastYear"><asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage6Info" runat="server" />        
                                <a href="BarnumSNDashboardGridOnBottom.aspx?Page=BarnumSNMetricsLastYear"><asp:Image ID="Image8" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage8Info" runat="server" />   
                                <a href="BarnumSNDashboard3GridOnBottom.aspx?Page=BarnumSNMetricsAllTime"><asp:Image ID="Image10" Visible="false" runat="server" /></a><br>
