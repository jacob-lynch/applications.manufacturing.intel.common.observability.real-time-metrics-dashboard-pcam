    ...
    <asp:UpdatePanel ID="UpdatePanelMaster" runat="server">
		...
		<table border=0 cellpadding=2 cellspacing=2>
		  <tr>
			...
			<form><input type="Button" value="Show Local Only" OnClick="window.location.href='Area_Local_TF.aspx?Page=ThinFilms'"></form>
		    </td>
		  </tr>
		 <tr>
		...
		<tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView1" CssClass="GridView" runat="server" Width="10%" GridLines="Vertical"
                                ...
                                <asp:GridView ID="GridView2" CssClass="GridView" runat="server" Width="10%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
                                ...
                                <asp:GridView ID="GridView3" CssClass="GridView" runat="server" Width="10%" GridLines="Vertical"
                                    RowStyle-CssClass="row" FooterStyle-CssClass="footer" PagerStyle-CssClass="pager"
                                    HeaderStyle-CssClass="hdr" AlternatingRowStyle-CssClass="altrow">
                                </asp:GridView>
				...
				<br><font face=Tahoma size=4><b>Recently Completed History</b></font>
				<hr style="height: 1px; border-width: 0; color: gray; background-color: gray" />
				...
				<br><font face=Tahoma size=4><b>Service Request Exceptions</b></font>
				<hr style="height: 1px; border-width: 0; color: gray; background-color: gray" />
