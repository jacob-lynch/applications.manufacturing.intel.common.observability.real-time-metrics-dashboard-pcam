...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/MES Entity Attributes_XEUS.htm"));
            ...
            <table border="0" cellpadding="2" cellspacing="2">
                <tr>
                         ...
                         <td valign="top">
                            ...
                            <asp:Label ID="lblGridView1Info" CssClass="LabelInfo" runat="server" Text=""></asp:Label><br>
