...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/Purge_Metrics_XEUS.htm"));
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <a href="GridOnly_Dashboard.aspx?Page=PurgeToolDetailsXEUS"><asp:Image ID="Image1" Visible="false" runat="server" /><br>
