...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/TIPR_Metrics.htm"));
...
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: black" /> -->
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <ContentTemplate>
                                <asp:Label ID="Text1" CssClass="LabelValue2" runat="server" Visible="false" />
                                &nbsp;
                            </ContentTemplate>
                        </asp:UpdatePanel>
<!--                        <hr style="height: 1px; border-width: 0; color: gray; background-color: gray" /> -->
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                                <a href="GridOnly_Dashboard.aspx?Page=MetricsCompleted"><asp:Image ID="Image1" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage1Info" CssClass="LabelInfo" runat="server" /><br>
                                <a href="GridOnly_Dashboard.aspx?Page=MetricsWC"><asp:Image ID="Image2" Visible="false" runat="server" /><br>
                                <asp:Label ID="lblImage2Info" CssClass="LabelInfo" runat="server" /><br>
                                <a href="GridOnly_Dashboard.aspx?Page=MetricsSC"><asp:Image ID="Image3" Visible="false" runat="server" /><br>
