...
<body topmargin="5" runat="server" id="Body1">
	...
	<%Response.Write("</td><td align=right>");%>
       <% 
         FileInfo f1 = new FileInfo(Server.MapPath("Output/TWT - F3 F4 AP Table Inventory.htm"));
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <ContentTemplate>
                            <td valign="top"><br>
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryAreaDetails"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryF3MissingAreaDetails"><asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryF4MissingAreaDetails"><asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage5Info" runat="server" />
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryAPMissingAreaDetails"><asp:Image ID="Image7" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage7Info" runat="server" />
                            </td>
                            <td valign="top"><br>
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryToolTypeDetails"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryTableDetails"><asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" />        
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryCEStateDetails"><asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage6Info" runat="server" />  
                                <a href="DashboardGridOnBottom.aspx?Page=TWTInventoryUnderscoreDetails"><asp:Image ID="Image8" Visible="false" runat="server" /></a><br>
