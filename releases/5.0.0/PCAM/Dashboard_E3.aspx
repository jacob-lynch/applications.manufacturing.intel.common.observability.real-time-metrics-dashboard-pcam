...
<table border="0" cellpadding="0" cellspacing="0">
 <tr>
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        ...
                        <ContentTemplate>
                            <td valign="top"><br>
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_1"><asp:Image ID="Image1" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage1Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_2"><asp:Image ID="Image3" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage3Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_3"><asp:Image ID="Image5" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage5Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_4"><asp:Image ID="Image7" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage7Info" runat="server" />                               
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_5"><asp:Image ID="Image9" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage9Info" runat="server" /> 
                            </td>
                            <td valign="top"><br>
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_1"><asp:Image ID="Image2" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage2Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_2"><asp:Image ID="Image4" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage4Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_3"><asp:Image ID="Image6" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage6Info" runat="server" />      
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_4"><asp:Image ID="Image8" Visible="false" runat="server" /></a><br>
                                <asp:Label ID="lblImage8Info" runat="server" />
                                <a href="GridOnly_Dashboard.aspx?Page=E3_Details_5"><asp:Image ID="Image10" Visible="false" runat="server" /></a><br>
